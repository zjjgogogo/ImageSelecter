...
public class ShowImageActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_gallery = (Button) findViewById(R.id.footer_gallery);
		...
		btn_camera.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (TempDataController.getSelectImageDatas().size() < imagesMaxSize) {
					...
					cameraUtil.cameraInit(ShowImageActivity.this);
				} else {
					Toast.makeText(
							ShowImageActivity.this,
	...
	protected void switchViewSkin() {
		...
		btn_gallery.setTextColor(mSkinUtil.headerBarTextColor);
	...
	protected void initFolderList() {
		...
		mFolderListLayout.setOnClickListener(new OnClickListener() {
	...
	OnLocalImageLoadTaskListener mLocalImageLoadTaskListener = new OnLocalImageLoadTaskListener() {
		...
		public void onEnd() {
			...
			mImageGridAdpater = new ImageGridAdpater(ShowImageActivity.this,
					mAllArrayList);
			mImageGridAdpater
					.setOnPreviewClicklistener(mPreViewOnClickListener);
